...
class LayerNormalization(Layer):
  ...
  def _can_use_fused_op(self, ndims):
    """Returns True if fused implementation can be used, and False otherwise.

    Checks if `self.axis` is contiguous and can be collapsed into its last axis;
    `self.axis` is assumed to have no duplicate or negative values.
    """
